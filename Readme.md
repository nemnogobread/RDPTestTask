#### Работоспособность кода можно посмотреть в демонстрации (видео в корневой папке)
...
Вообще можно было и на линуксе это всё сделать, но у меня была открыта винда, поэтому что есть то есть, результат один)